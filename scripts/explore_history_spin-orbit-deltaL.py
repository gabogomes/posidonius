...
#    ax.legend(loc=0, prop={'size':8})
    ...
    ax = fig.add_subplot(2,2,2, sharex=ax)
    field = 'eccentricity'
    for key in planets_keys:
        planet_data = planets_data[key]
...
#    #plt.setp(ax.get_xticklabels(), visible=False)
    ...
    ax = fig.add_subplot(2,2,4, sharex=ax)
    field = '$\Delta L/L_{0}$'
...
#        data['mean_energy_lost_due_to_tides_W_per_m2'] = planets_computed_data[key]['mean_tidal_flux']
        data['planet_rotation_period_hours'] = planets_computed_data[key]['planet_rotation_period']
