...
#for i in range(1512): # don't need this
transit_time=np.loadtxt('lhs3844b_history_transit_times_sync_005_WH.txt',usecols=1)
transit_number=np.loadtxt('lhs3844b_history_transit_times_sync_005_WH.txt',usecols=0)
model=LinearRegression().fit(transit_number.reshape((-1,1)),transit_time)
T_initial=model.intercept_
mean_period=model.coef_
#print(T_initial,mean_period*365.25)
...
#for i in range(1512): # don't need this
transit_time=np.loadtxt('lhs3844b_history_transit_times_32_1.txt',usecols=1)
transit_number=np.loadtxt('lhs3844b_history_transit_times_32_1.txt',usecols=0)
model=LinearRegression().fit(transit_number.reshape((-1,1)),transit_time)
T_initial=model.intercept_
mean_period=model.coef_
#print(T_initial,mean_period*365.25)
...
#for i in range(1512): # don't need this
transit_time=np.loadtxt('lhs3844b_history_transit_times_32_1_WH.txt',usecols=1)
transit_number=np.loadtxt('lhs3844b_history_transit_times_32_1_WH.txt',usecols=0)
model=LinearRegression().fit(transit_number.reshape((-1,1)),transit_time)
T_initial=model.intercept_
mean_period=model.coef_
#print(T_initial,mean_period*365.25)
