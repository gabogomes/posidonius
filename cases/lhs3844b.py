...
##################################################################################################################################
    ...
    # Radiuses in R_EARTH
    planet_radius = 1.303 * posidonius.constants.R_EARTH
    planet_radius_of_gyration = 5.75e-01 # Earth type planet
    # Masses in M_SUN
    planet_mass = 3.0e-6*3.03 # Solar masses (3.0e-6 solar masses = 1 earth mass) 3.03 3.78 10^18 10^20
    # Uniform viscosity coefficient in Pa s
    planet_uniform_viscosity_coefficient = 1.0e24

    a = 0.00623;                           # semi-major axis (in AU)
    e = 0.01;                               # eccentricity
