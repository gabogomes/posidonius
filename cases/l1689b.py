...
if __name__ == "__main__":
    ...
    initial_time = 0.0
    time_step = 0.01  # days - (0.01)
    #time_step = 0.05 # days
    #time_limit   = 4*time_step # days
    #time_limit   = 365.25 * 1.0e8 # days
    time_limit   = 365.25 * 2.0e0 # days
    historic_snapshot_period = 0.01 # days
    ...
    star_mass = 0.62 # Solar masses
    star_radius_factor = 0.600
...
##################################################################################################################################
    ...
    # Radiuses in R_EARTH
    planet_radius = 1.39 * posidonius.constants.R_EARTH
    planet_radius_of_gyration = 5.75e-01 # Earth type planet
    # Masses in M_SUN
    planet_mass = 3.0e-6*4.60 # Solar masses (3.0e-6 solar masses = 1 earth mass) 3.03 3.78 10^18 10^20
    # Uniform viscosity coefficient in Pa s
    planet_uniform_viscosity_coefficient = 1.0e23

    a = 0.02091;                           # semi-major axis (in AU)
    ...
    eta = planet_uniform_viscosity_coefficient;
    ...
    k2pdelta = 0.0 # Terrestrial planets (no gas)
...
#        }
    ...
    planet_tides_parameters_creep = {
        ...
        "dissipation_factor": 0.0,
        "love_number": 0.0,
        "uniform_viscosity_coefficient": (eta * posidonius.constants.AU * posidonius.constants.DAY / posidonius.constants.M_SUN),
