...
##################################################################################################################################
    ...
    # Radiuses in R_EARTH
    planet_radius = 0.918e0 * posidonius.constants.R_EARTH
    planet_radius_of_gyration = 5.75e-01 # Earth type planet
    # Masses in M_SUN
    planet_mass = 1.8850689e-06 # Solar masses (3.0e-6 solar masses = 1 earth mass)
    # Uniform viscosity coefficient in Pa s
    planet_uniform_viscosity_coefficient = 1.0e18

    a = 0.01;                            # semi-major axis (in AU)
    e = 0.3;                               # eccentricity
    ...
    l = 165.724187804 * posidonius.constants.DEG2RAD;                      # mean anomaly (degrees)
    ...
    planet_angular_frequency = posidonius.constants.TWO_PI * 20.0/(planet_pseudo_synchronization_period) # days^-1
