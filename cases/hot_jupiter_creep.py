...
##################################################################################################################################
    ...
    # Radiuses in R_EARTH
    planet_radius = 3.865 * posidonius.constants.R_EARTH
    planet_radius_of_gyration = 5.75e-01 # Earth type planet
    # Masses in M_SUN
    planet_mass = 3.0e-6*17.147 # Solar masses (3.0e-6 solar masses = 1 earth mass)
    # Uniform viscosity coefficient in Pa s
    planet_uniform_viscosity_coefficient = 1.0e14

    a = 0.041;                            # semi-major axis (in AU)
    e = 0.1;                               # eccentricity
