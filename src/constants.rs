...
//pub const INTEGRATOR_MIN_DT : f64 = 0.00045;             // Optimal values for TTV analysis of close-in planets (P_orb approx 1 - 2 days)
//pub const INTEGRATOR_MAX_DT : f64 = 0.0005;          // Optimal values for TTV analysis of close-in planets (P_orb approx 1 - 2 days)
pub const INTEGRATOR_MIN_DT : f64 = 0.;             // 0.01 Minimum timestep used as a floor when adaptive timestepping is enabled (default: 0.).
pub const INTEGRATOR_MAX_DT : f64 = 0.01;          // 0.01 Maximum timestep used as a ceiling when adaptive timestepping is enabled (default: 0. => disabled).
